...
class PlatformAPI
{
    ...
    public function setConsumerData($consumerKey, $consumerSecret, $store, $currency, $group_id, $resubscribe, $ignoreList, $create_segments, $shop_name, $shop_id, $popups_enabled)
    {
        ...
        return $this->api->setConsumerData($consumerKey, $consumerSecret, $store, $currency, $group_id, $resubscribe, $ignoreList, $create_segments, $shop_name, $shop_id, $popups_enabled);
    }
    ...
    {
        return $this->api->createShop($name, $url, $currency, $group_id, $enable_popups, $access_data);
    }
    ...
    public function syncProduct( $shop_id, $product_id, $name, $price, $exclude_automation, $url, $image, $categories )
    {
        ...
        return $this->api->syncProduct( $shop_id, $product_id, $name, $price, $exclude_automation, $url, $image, $categories );
    }
    ...
    public function deleteProduct( $shop_id, $product_id)
    {
        ...
        return $this->api->deleteOrder( $shop_id, $product_id );
    }
